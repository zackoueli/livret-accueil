        ...
        return (
          <div key={c.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
            <div style={{ minWidth: 0 }}>
              <p style={{ margin: 0, fontSize: 13, fontWeight: 600, color: C.label }}>{c.label}</p>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, background: C.bg, borderRadius: 12, padding: "4px 6px", flexShrink: 0 }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 700, color: C.label, minWidth: 16, textAlign: "center" }}>{qty}</span>
              ...
              <a key={i} href={r.url} target="_blank" rel="noopener noreferrer"
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <p style={{ margin: "2px 0 0", fontSize: 12, color: C.sub }}>{tr("leave_review")}</p>
                  </div>
                </div>
