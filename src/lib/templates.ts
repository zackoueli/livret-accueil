...
export const TEMPLATES: BookletTemplate[] = [
  {
    id: "jade",
    name: "Jade",
    description: "Blanc épuré, grille de modules, style hôtel moderne",
    preview: "🏨",
    accentColor: "#0891b2",
    splashOverlay: "dark",
  ...
  },
  {
    id: "oree",
    name: "Orée",
    description: "Beige chaud, widgets photo, style maison de charme",
    preview: "🪵",
    accentColor: "#c4834a",
    splashOverlay: "dark",
    splashTitleFont: "sans",
    ...
    splashTitleWeight: "bold",
    splashTitleColor: "#ffffff",
    splashSubtitleColor: "rgba(255,255,255,0.65)",
    splashButtonColor: "#c4834a",
    splashButtonTextColor: "#ffffff",
    splashBadgeText: "Mon séjour",
    splashButtonText: "Accéder →",
    headerBg: "#f5f0e8",
    cardBg: "#ffffff",
    cardBorder: "#e8e0d4",
    cardRadius: "lg",
