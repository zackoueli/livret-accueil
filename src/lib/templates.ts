...
export const TEMPLATES: BookletTemplate[] = [
...

  {
    ...
    coverImage: "https://firebasestorage.googleapis.com/v0/b/livret-d-accueil-b98ba.firebasestorage.app/o/Templates%20pr%C3%A9remplis%2Fpexels-valentin-ivantsov-2154772556-35418211%20(1).jpg?alt=media",
    modules: () => makeModules({
      arrival: {
...

  {
    ...
    coverImage: "https://firebasestorage.googleapis.com/v0/b/livret-d-accueil-b98ba.firebasestorage.app/o/Templates%20pr%C3%A9remplis%2Fpexels-francesco-ungaro-30735588.jpg?alt=media",
    modules: () => makeModules({
      arrival: {
...

  {
    ...
    coverImage: "https://firebasestorage.googleapis.com/v0/b/livret-d-accueil-b98ba.firebasestorage.app/o/Templates%20pr%C3%A9remplis%2Fpexels-marek-piwnicki-3907296-17917579.jpg?alt=media",
    modules: () => makeModules({
      arrival: {
...

  {
    ...
    coverImage: "https://firebasestorage.googleapis.com/v0/b/livret-d-accueil-b98ba.firebasestorage.app/o/Templates%20pr%C3%A9remplis%2Fpexels-vlada-karpovich-7902916.jpg?alt=media",
    modules: () => makeModules({
      arrival: {
